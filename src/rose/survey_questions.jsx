...
const SurveyQuestionsSection = () => {
 ...
 <section className="w-full md:py-16 py-12 md:px-12 px-6 relative w-full mx-auto p-8">
    <div className='flex-col font-zain justify-center items-center gradient-topleft-bottomright border border-[#D14D72] border-[3.5px] rounded-3xl p-8'>
         {/* title */}
      ...
      {questions.map((q, idx) => (
        <div key={idx} className="space-y-6">
          ...
          <div className="flex flex-col lg:flex-row  justify-between items-center md:items-start gap-8">
            {/* Text Column */}
        ...
        <div className="space-y-12 pt-12 flex flex-col justify-between items-center md:items-start gap-8" dir='rtl'>
            {/* q6 */}
            <div>
                 <div className="text-right font-zain space-y-2 w-[80%] lg:w-1/2" dir="rtl">
...
لمنزلك دون الحاجه الى الذهاب بنفسك والإنتظار؟</h2>
            ...
            <div>
                <img src="/assets/rose/q6.svg" alt="Survey Chart" className=" w-full" />
            </div>
            </div>
            {/* q7 */}
             <div>
...
لمنزلك دون الحاجه الى الذهاب بنفسك والإنتظار؟</h2>
            ...
            <div>
                <img src="/assets/rose/q7.svg" alt="Survey Chart" className=" w-full" />
            </div>
            </div>
