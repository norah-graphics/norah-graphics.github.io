...
const TimelineSection = () => {
  return (
    <section className="w-full py-16 px-4 md:block hidden">
      ...
      {/* Month 1 phone */}
      <div className="flex flex-col items-center relative w-full md:hidden flex">
        ...
        <div className="text-[#00A0FF] font-bold mt-2 text-2xl font-noto-sans text-center">البحث والتحليل</div>
      ...
      <div className="flex flex-col items-center relative w-full md:hidden flex">
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 flex flex-col justify-end items-center pb-4">
            ...
            <div className="text-[#56BCC7] font-bold text-2xl font-noto-sans text-center">تطوير نموذج الذكاء الاصطناعي</div>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center relative w-full">
        ...
        <div className="text-[#00A0FF] font-bold mt-2 text-2xl font-noto-sans text-center">تجربة المستخدم والتصميم</div>
        <ul dir="rtl"  className="text-black text-baseleading-tight text-center mt-2 px-2 font-noto-sans">
      ...
      {/* Month 2 */}
      <div className="flex flex-col items-center relative w-full md:flex hidden">
        <div className="relative w-full">
          {/* Hidden image to determine height */}
          <img 
            src="/assets/month2.svg" 
